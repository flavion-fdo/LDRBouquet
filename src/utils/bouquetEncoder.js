...
export const PRESET_BOUQUETS = [
  {
    ...
    wrapperStyle: 'kraft',
    ribbonColor: '#e11d48',
    tagTo: 'My Love in London 🇬🇧',
    tagFrom: 'Yours in New York 🇺🇸',
    tagDistance: '3,450 Miles Apart ✈️',
  ...
  },
  {
    ...
    ribbonColor: '#d97706',
    tagTo: 'My Soulmate in Tokyo 🇯🇵',
    tagFrom: 'With Love from Paris 🇫🇷',
    tagDistance: '6,030 Miles ✈️',
